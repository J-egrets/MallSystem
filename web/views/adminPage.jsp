        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="navbar-header">
                    ...
                    <a href="${pageContext.request.contextPath}/views/adminPage.jsp" class="navbar-brand">${user.getUserName()}</a>
                </div>

                <div class="navbar-collapse collapse" id="mobile_menu">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#" onclick="change('pageChangeGoods','?clazz=Goods')">主页</a></li>
                        <li><a href="#" onclick="change('pageChangeUser','?clazz=dealUserList')">用户管理</a></li>
                        <li><a href="#" onclick="change('dealOrder','?clazz=dealOrder')">订单管理</a></li>
                        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">商品管理 <span
                                class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="#" onclick="change('pageChangeGoods','?clazz=Goods')">商品列表</a></li>
                                <li><a href="#" onclick="change1('addGoods')">添加新商品</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="glyphicon glyphicon-user"></span> 个人中心 <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
...
<iframe id="iframe" name="iframe" src="${pageContext.request.contextPath}/views/admin/welcome.jsp" scrolling="no" frameborder="0" width="100%" height="80%"></iframe>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/pageJumpAdmin.js"></script>
